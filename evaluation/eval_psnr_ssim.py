...
if __name__ == '__main__': 
    ...
    for video in videos: 
        ...
        for index in range(NF): 
            psnr_.append(calculate_psnr(img1=img_gen_list[index], img2=img_gt_list[index], crop_border=0))
            ssim_.append(calculate_ssim(img1=img_gen_list[index], img2=img_gt_list[index], crop_border=0))
        psnr.append(np.mean(psnr_))
